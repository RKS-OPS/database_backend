...
## Available Scripts
- npm start or npm run start: Starts the server and runs the src/index.js file.

- npm run dev: Starts the server using nodemon to automatically restart the server when files change, ideal for development.

- npm run swagger: Runs the Swagger configuration file to start the API documentation interface.
